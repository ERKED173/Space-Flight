...
public class ResetTheGame {
    ...
    InfoAndStats.upgradeDetail.setRocketDetailAccessibility(false);
    InfoAndStats.upgradeDetail.setRocketDetailAmount(0);
    InfoAndStats.upgradeDetail.setRocketDetailImpulse(0.0F);
    InfoAndStats.upgradeDetail.setRocketDetailLevel(0);
    InfoAndStats.upgradeDetail.setRocketDetailPrice(0);
    InfoAndStats.upgradeDetail.setRocketDetailThrust(0.0F);
    InfoAndStats.upgradeDetail.setRocketDetailTime(0.0F);
