...
public class ImgResDraw {
	
	public static final Texture backButtonInactive = new Texture("btns/button_back_inactive.png");
	public static final Texture backButtonActive = new Texture("btns/button_back_active.png");
	
	public static final Texture dialogWindow = new Texture("objects/dialogWindow.png");
	...
	public static final Texture backButtonInactiveRU = new Texture("btns/RU/button_back_inactive_RU.png");
	public static final Texture backButtonActiveRU = new Texture("btns/RU/button_back_active_RU.png");
	public static final Texture aboutButtonInactiveRU = new Texture("btns/RU/button_about_inactive_RU.png");
	public static final Texture aboutButtonActiveRU = new Texture("btns/RU/button_about_active_RU.png");
	public static final Texture exitButtonInactiveRU = new Texture("btns/RU/button_exit_inactive_RU.png");
