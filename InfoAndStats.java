...
public class InfoAndStats {
	...
	public static final String[] orderList3 = {"Improving communication","Increasing navigation","Experiments"};
	public static final String[] orderList3RU = {"Улучшение связи","Увеличение навигации","Эксперименты"};
